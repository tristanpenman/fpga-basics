...
xst -ifn xst.scr
move clock_divider_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clock_divider_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clock_divider_exdes.ucf clock_divider_exdes

echo 'Running map'
map -timing -pr b clock_divider_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm clock_divider_exdes -w routed.ncd routed.vhd
cd ..
